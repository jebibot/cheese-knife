    ...
    if (volumeControl != null) {
      try {
        compressor = new Vue({
          ...
          computed: {
            label() {
              return `오디오 컴프레서 ${this.enabled ? "비활성화" : "활성화"}`;
            },
            ariaValuenow() {
